          ...
          >
            ...
            <div className="p-2.5 md:p-8">
              ...
              <motion.button
                ...
                className="w-full text-sm 2xl:text-xl 3xl:text-2xl bg-[#4CAF4F] hover:bg-[#43A047] text-white font-semibold py-4 md:px-8 rounded-xl flex items-center justify-center gap-3 transition-all duration-300 hover:scale-[1.02] cursor-pointer border-none shadow-[0_4px_20px_rgba(76,175,79,0.3)]"
              >
                Get Started with {service.title}
                <FaArrowRight size={18} className=" 3xl:h-7 3xl:w-7" />
              </motion.button>
            </div>
          </div>
        </motion.div>
